...
// Game state variables (declared at the top for access)
let board = [];
...
document.addEventListener('DOMContentLoaded', () => {
  // Audio setup (must be inside DOMContentLoaded so elements exist!)
  const sounds = {
  ...
  // --- Event Listeners for Reset/Modal Close (already set up above) ---
